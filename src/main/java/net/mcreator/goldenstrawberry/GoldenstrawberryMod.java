 ...
 *
 */
package net.mcreator.goldenstrawberry;
...
import net.mcreator.goldenstrawberry.init.GoldenstrawberryModTabs;
...
@Mod("goldenstrawberry")
public class GoldenstrawberryMod {
	public static final Logger LOGGER = LogManager.getLogger(GoldenstrawberryMod.class);
	public static final String MODID = "goldenstrawberry";

	public GoldenstrawberryMod() {
		...
		GoldenstrawberryModFluids.REGISTRY.register(bus);
		GoldenstrawberryModFluidTypes.REGISTRY.register(bus);
	}
